                ...
                <v-form ref="loginForm" @submit.prevent="handleLogin">
                  ...
                  <div class="d-flex justify-space-between align-center mb-6">
                    <v-checkbox
                      ...
                      label="记住我"
                    />
                    <a class="text-caption text-primary text-decoration-none" href="#">
                      忘记密码?
                    </a>
                  </div>
                  ...
                  <div class="text-center">
                    ...
                    <a class="text-body-2 text-primary text-decoration-none ml-2" href="#">
                      立即注册
                    </a>
                  </div>
                </v-form>
...
<script setup>
  ...
  const totalMessages = ref(56_789)

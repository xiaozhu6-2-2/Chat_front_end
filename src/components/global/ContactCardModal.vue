        ...
        <div class="contact-details">
          <v-list density="compact" lines="two">
            ...
            <v-list-item v-if="isContactFriend && contactInfo.tag" prepend-icon="mdi-tag" title="标签">
              <template #subtitle>
                <v-chip color="primary" size="small">{{ contactInfo.tag }}</v-chip>
              </template>
            </v-list-item>
...
<script setup lang="ts">
  ...
  import type { ContactCardModalEmits, ContactCardModalProps, type ContactData, isFriend } from '../../types/componentProps'

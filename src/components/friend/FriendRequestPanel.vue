  ...
  <div class="friend-request-panel">
    <v-tabs v-model="activeTab" color="primary" class="mb-4">
      <v-tab value="received">
        <v-icon icon="mdi-inbox-arrow-down" class="mr-2"></v-icon>
        收到的请求
        <v-badge
    ...
    <v-window v-model="activeTab">
      ...
      <v-window-item value="received">
        ...
        <div v-else class="text-center py-8">
          <v-icon icon="mdi-inbox-arrow-down-outline" size="64" color="grey-lighten-1"></v-icon>
      ...
      <v-window-item value="sent">
        ...
        <div v-else class="text-center py-8">
          <v-icon icon="mdi-send-outline" size="64" color="grey-lighten-1"></v-icon>

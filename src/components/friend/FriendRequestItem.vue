...
<script setup lang="ts">
  import type { FriendRequestItemEmits, FriendRequestItemProps } from '../../types/searchAndRequest'
  ...
  function getDisplayName () {
    return props.type === 'received' ? props.request.sender_info?.username || `用户${props.request.sender_uid}` : `用户${props.request.receiver_uid}`
  }
